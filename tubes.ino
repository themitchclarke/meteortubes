...
#define POWER_SUPPLY_VOLTAGE 5 // Voltage of your power supply
#define MAX_CURRENT_MILLIAMPS 10000 // Set to your power supply’s max current in mA

#define NUM_LEDS_PER_TUBE 60    // Total LEDs per tube
#define NUM_TUBES 5            // Total number of tubes
...
// Create a CRGB array to hold the color data for each LED
CRGB leds[TOTAL_LEDS];
CRGB effectColorCRGB = CRGB::Blue; // Default effect color
...
// Set up the delay time between steps (adjust for speed)
...
/*
  Since ButtonEffect1 is READ_WRITE variable, onButtonEffect1Change() is
  executed every time a new value is received from IoT Cloud.
*/
void onButtonEffect1Change()  {
  // Add your code here to act upon ButtonEffect1 change
}
/*
  Since ButtonEffect2 is READ_WRITE variable, onButtonEffect2Change() is
  executed every time a new value is received from IoT Cloud.
*/
void onButtonEffect2Change()  {
  // Add your code here to act upon ButtonEffect2 change
}
/*
  Since ButtonEffect3 is READ_WRITE variable, onButtonEffect3Change() is
  executed every time a new value is received from IoT Cloud.
*/
void onButtonEffect3Change()  {
  // Add your code here to act upon ButtonEffect3 change
}
...
void loop() {
  ArduinoCloud.update();
  // Your code here 
 // Check each button and apply the corresponding effect
  if (buttonPacifica) {
    effectPacifica();  // Run the chase effect
  } else if (buttonGlitter) {
    effectGlitter();  // Run a blink effect
  } else if (buttonRainbow) {
    effectRainbow();  // Run a rainbow effect
  } else if (buttonDrip) {
    effectDrip(); // Run a drip effect
  } else if (buttonMatrix) { // Add a button for the twinkle effect
    effectMatrix();
  } else if (buttonCountdown) {
  if (!countdownComplete) {
    effectCountdown();
    countdownComplete = true; // Mark countdown as complete
  } else {
    effectJuggle(); // Sustain juggle animation
  }
  } else if (buttonJuggle) {
    effectJuggle();
  } else {
    FastLED.clear();
    FastLED.show(); // Turn off LEDs if no effect button is active
  }
}

/*
  Since ButtonEffect4 is READ_WRITE variable, onButtonEffect4Change() is
  executed every time a new value is received from IoT Cloud.
*/
void onButtonEffect4Change()  {
  // Add your code here to act upon ButtonEffect4 change
}

/*
  Since ColorSet is READ_WRITE variable, onColorSetChange() is
  executed every time a new value is received from IoT Cloud.
*/
void onColorSetChange()  {
  // Add your code here to act upon ColorSet change
}

/*
  Since TwinkleDensity is READ_WRITE variable, onTwinkleDensityChange() is
  executed every time a new value is received from IoT Cloud.
*/
void onTwinkleDensityChange()  {
  // Add your code here to act upon TwinkleDensity change
}

/*
  Since ButtonEffect5 is READ_WRITE variable, onButtonEffect5Change() is
  executed every time a new value is received from IoT Cloud.
*/
void onButtonEffect5Change()  {
  // Add your code here to act upon ButtonEffect5 change
}


/*
  Since TwinkleSpeed is READ_WRITE variable, onTwinkleSpeedChange() is
  executed every time a new value is received from IoT Cloud.
*/
void onTwinkleSpeedChange()  {
  // Add your code here to act upon TwinkleSpeed change
}

/*
  Since ButtonRedWhite is READ_WRITE variable, onButtonRedWhiteChange() is
  executed every time a new value is received from IoT Cloud.
*/
void onButtonRedWhiteChange()  {
  // Add your code here to act upon ButtonRedWhite change
}

/*
  Since ButtonBlink is READ_WRITE variable, onButtonBlinkChange() is
  executed every time a new value is received from IoT Cloud.
*/
void onButtonBlinkChange()  {
  // Add your code here to act upon ButtonBlink change
}



/*
  Since ButtonRainbow is READ_WRITE variable, onButtonRainbowChange() is
  executed every time a new value is received from IoT Cloud.
*/
void onButtonRainbowChange()  {
  // Add your code here to act upon ButtonRainbow change
}


/*
  Since ButtonDrip is READ_WRITE variable, onButtonDripChange() is
  executed every time a new value is received from IoT Cloud.
*/
void onButtonDripChange()  {
  // Add your code here to act upon ButtonDrip change
}


/*
  Since ButtonTwinkle is READ_WRITE variable, onButtonTwinkleChange() is
  executed every time a new value is received from IoT Cloud.
*/
void onButtonTwinkleChange()  {
  // Add your code here to act upon ButtonTwinkle change
}


/*
  Since EffectColor is READ_WRITE variable, onEffectColorChange() is
  executed every time a new value is received from IoT Cloud.
*/
void onEffectColorChange()  {
  switch (effectColor) {
    ...
    default: effectColorCRGB = CRGB::Black; break; // Default to off
  }
}


/*
  Since ButtonAurora is READ_WRITE variable, onButtonAuroraChange() is
  executed every time a new value is received from IoT Cloud.
*/
void onButtonAuroraChange()  {
  // Add your code here to act upon ButtonAurora change
}


/*
  Since ButtonJuggle is READ_WRITE variable, onButtonJuggleChange() is
  executed every time a new value is received from IoT Cloud.
*/
void onButtonJuggleChange()  {
  // Add your code here to act upon ButtonJuggle change
}

/*
  Since CloudSelectedPalette is READ_WRITE variable, onCloudSelectedPaletteChange() is
  executed every time a new value is received from IoT Cloud.
*/
void onCloudSelectedPaletteChange()  {
  // Add your code here to act upon CloudSelectedPalette change
}


/*
  Since TwinkleScale is READ_WRITE variable, onTwinkleScaleChange() is
  executed every time a new value is received from IoT Cloud.
*/
void onTwinkleScaleChange()  {
  // Add your code here to act upon TwinkleScale change
}

/*
  Since ButtonMatrix is READ_WRITE variable, onButtonMatrixChange() is
  executed every time a new value is received from IoT Cloud.
*/
void onButtonMatrixChange()  {
  // Add your code here to act upon ButtonMatrix change
}

/*
  Since ButtonGlitter is READ_WRITE variable, onButtonGlitterChange() is
  executed every time a new value is received from IoT Cloud.
*/
void onButtonGlitterChange()  {
  // Add your code here to act upon ButtonGlitter change
}

/*
  Since ButtonPacifica is READ_WRITE variable, onButtonPacificaChange() is
  executed every time a new value is received from IoT Cloud.
*/
void onButtonPacificaChange()  {
  // Add your code here to act upon ButtonPacifica change
}

/*
  Since ButtonCountdown is READ_WRITE variable, onButtonCountdownChange() is
  executed every time a new value is received from IoT Cloud.
*/
void onButtonCountdownChange()  {
  // Add your code here to act upon ButtonCountdown change
  countdownComplete = false;
}

/*
  Since CloudPaletteSetIndex is READ_WRITE variable, onCloudPaletteSetIndexChange() is
  executed every time a new value is received from IoT Cloud.
*/
void onCloudPaletteSetIndexChange()  {
  // Add your code here to act upon CloudPaletteSetIndex change
}
